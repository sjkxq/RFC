package com.sjkxq.client.proxy;

import com.sjkxq.client.circuitbreaker.CircuitBreaker;
import com.sjkxq.client.circuitbreaker.CircuitBreakerProvider;
import com.sjkxq.client.retry.GuavaRetry;
import com.sjkxq.client.rpcclient.RpcClient;
import com.sjkxq.client.rpcclient.impl.NettyRpcClient;
import com.sjkxq.client.servicecenter.ServiceCenter;
import com.sjkxq.client.servicecenter.ZKServiceCenter;
import com.sjkxq.trace.interceptor.ClientTraceInterceptor;
...
public class ClientProxy implements InvocationHandler {
    ...
    public <T> T getProxy(Class<T> clazz) {
        ...
        if (!clazz.isInstance(proxy)) {
            throw new IllegalStateException("Proxy does not implement the target interface: " + clazz.getName());
        }
        return (T) proxy;
    }
